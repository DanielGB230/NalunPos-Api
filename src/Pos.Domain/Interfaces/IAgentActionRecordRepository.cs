...
public interface IAgentActionRecordRepository
{
    ...
    Task<(IReadOnlyList<AgentActionRecord> Items, int TotalCount)> GetPendingActionsPagedAsync(int pageNumber = 1, int pageSize = 20, CancellationToken cancellationToken = default);
