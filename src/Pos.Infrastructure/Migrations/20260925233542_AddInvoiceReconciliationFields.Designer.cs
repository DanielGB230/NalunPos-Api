...
namespace Pos.Infrastructure.Migrations
{
    ...
    [Migration("20260925233542_AddInvoiceReconciliationFields")]
    partial class AddInvoiceReconciliationFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pos.Domain.Entities.User", b =>
                {
                    ...
                    b.ToTable("Users", null, t =>
                        {
                            t.HasCheckConstraint("CK_Users_PlatformRole", "[TenantId] IS NOT NULL OR [RoleId] = '00000000-0000-0000-0000-000000000001'");
                        });
                });
